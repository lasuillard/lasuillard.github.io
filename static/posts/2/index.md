...
안정적인 데이터 추출 방법을 선택하기 위해 현재 사용 중인 방법들과 대안들을 검토했습니다.
...
- 프라이빗 서브넷에 위치한 데이터베이스에 접근하기 위해 배스천(Bastion) 호스트를 경유하는 SSH 터널링을 이용해야 했고, 이 SSH 키를 안전하게 관리해야 했습니다.
