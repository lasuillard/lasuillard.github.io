...
개발 환경이 그럴진대, 서버 애플리케이션을 Windows에 배포하는 것은 어떨까요? 가상화 및 컨테이너 기술이 발전하면서 제 주변에서 Linux 외의 환경에 서버 애플리케이션을 배포하는 것은 흔히 보기 어려워졌습니다. 어디서든 Linux 환경에서 개발할 수 있게 되었고, Linux 환경에서 서버 애플리케이션을 배포하는 것이 훨씬 쉽고 편리해졌기 때문입니다.
