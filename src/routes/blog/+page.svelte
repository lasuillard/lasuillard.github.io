		...
		<div class="mt-7">
			...
			<div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3">
				{#each data.allPosts as post}
					<!-- Post card-->
					<div class="card card-compact md:card-normal lg:h-30 shadow-lg m-2 rounded-lg">
						...
						<div class="card-body">
							...
							<!-- Badges -->
							<div class="flex flex-cols overflow-x-scroll p-1 pb-2">
