		...
		<div class="mt-8 flex justify-end pr-4">
			<div class="flex space-x-4 rounded-lg p-2 px-3 dark:bg-white">
				...
				<a href="https://github.com/lasuillard">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 98 96" class="h-7 w-7 lg:h-9 lg:w-9">
						<path
							fill-rule="evenodd"
							clip-rule="evenodd"
				...
				<a href="https://www.linkedin.com/in/%EC%9C%A0%EC%B0%AC-%EC%9D%B4-67751020b/">
					<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 72 72" class="h-7 w-7 lg:h-9 lg:w-9">
						<path
